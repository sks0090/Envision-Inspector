...
{
	m_picbox->GetClientRect(&rectViewClient);				// picture box 기준 picture box 좌표
	m_picbox->GetWindowRect(rectViewWindow);				// Window 기준 picture box 좌표
	m_picbox->GetParent()->ScreenToClient(rectViewWindow);	// Dialog 기준 picture box 좌표
